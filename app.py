            ...
            with container:
                ...
                if tipo_grafico == "Pizza":
                    ...
                    fig.update_layout(
                        ...
                        height=altura,
                        dragmode=False,
                        # Aumentado a margem direita (r) para dar espaço para o texto da legenda
                        margin=dict(l=20, r=160, t=40, b=40),
                        legend=dict(
                            orientation="v",
                            # Deslocado sutilmente para a esquerda para evitar cortes na lateral direita
                            x=0.98,
                            y=0.5,
                            xanchor="left",
                            yanchor="middle",
                    ...
                    fig.update_xaxes(
                        type="category",
                        # "auto" faz com que fique reto no computador e incline automaticamente em telas de celular
                        tickangle="auto",
                        dtick=1,
                        tickmode="array",
